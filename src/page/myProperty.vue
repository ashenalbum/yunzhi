    ...
    methods: {
        getData(){
            axios({
                ...
                this.num = data.content.accounts && data.content.accounts.money.balance;
...
<style scoped>
.nav-bar{width:100%;}
.top{box-sizing:border-box; width:6.9rem; height:3.2rem; padding:0.4rem; background:url(~@/assets/other/top-bg1.png) no-repeat; background-size:100% 100%;}
.list{width:6.9rem;}
